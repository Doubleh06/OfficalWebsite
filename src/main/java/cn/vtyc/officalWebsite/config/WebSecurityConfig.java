package cn.vtyc.officalWebsite.config;

import cn.vtyc.officalWebsite.security.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        //对以下路径忽略过滤
        web.ignoring().antMatchers("/static/**", "/login", "/remote/**", "/test/**", "/checkextuser","/employee/**","/frontApi/**","/downloadFile/**");
    }
